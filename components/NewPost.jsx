...
import {getSingleSimilarPosts} from "../services/index"

function NewPost({categories, slug}) {
  ...
  return (
   <>
        ...
        <div className="relative h-72" key={index}>
            ...
            <div className="transition duration-500 hover:-translate-x-3 hover:bg-indigo-700 hover:text-white absolute arrow-btn -left-5 mt-10 top-20 text-center py-3  px-3 cursor-pointer bg-white rounded-full">
